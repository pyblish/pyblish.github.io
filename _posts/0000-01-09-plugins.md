...
> You can change the manner in which plugins are discovered via your user-configuration file, we'll be learning more about this in later tutorials.
...
### [[Configuring Pyblish >>|configuring-pyblish]]